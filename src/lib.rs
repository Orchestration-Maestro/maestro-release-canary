//! Checked arithmetic for the binary consumer fixture.
...
///
/// ```
/// assert_eq!(maestro_release_canary::checked_sum(20, 22), Some(42));
/// assert_eq!(maestro_release_canary::checked_sum(u32::MAX, 1), None);
/// ```
#[must_use]
